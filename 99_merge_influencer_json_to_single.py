...
if __name__ == "__main__":
    # 這是你包含多個網紅資料夾的根目錄
    SOURCE_DIR = r"T:\Code\Task\Multimodel_Gemini_Prompt_Display\data\analysis" 
    # 這是你要產出給前端使用的合併檔目錄 (對應 all_video.js 的讀取路徑)
    TARGET_DIR = r"T:\Code\Task\Multimodel_Gemini_Prompt_Display\data\json_description" 
